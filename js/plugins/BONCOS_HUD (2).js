...
(() => {
  ...
  class Window_BoncosBars extends Window_Base {
    ...
    drawStatBar(label, value, y, color1, color2) {
      const rate = Math.max(0, Math.min(1, value / 100));
      const barX = 0;
      const barY = y + this.lineHeight() - 10;
    ...
    refresh() {
      ...
      this.drawStatBar("Energi", energi, 4, "#ffc845", "#ff9d00");
      this.drawStatBar("Nilai", nilai, lh + 20, "#4fcfa0", "#28a374");
    }
  }
