...
~struct~Label
  ...
  @text Posisi X (tile)
  @type number
  @desc Koordinat X tile tempat pintugedung berada
  @default 0
 
  @param y
  @text Posisi Y (tile)
  @type number
  @desc Koordinat Y tile tempat pintugedung berada
  @default 0
  ...
  pintu), menunjukkan nama gedungruangan. Teksnya IKUT SCROLL KAMERA,
  ...
  3. Klik tombol untuk tambah baris baru, isi
     ...
     - Teks Label nama yang mau ditampilkan, misal KOS, KAMPUS,
       MARKETPLACE.
  4. Ulangi untuk tiap pintugedung yang mau dikasih label.
